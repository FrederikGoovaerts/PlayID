package playid.domain.gdl_transformers.second_phase;

import static playid.domain.fodot.FodotElementBuilder.createAnd;
import static playid.domain.fodot.FodotElementBuilder.createDistinct;
import static playid.domain.fodot.FodotElementBuilder.createFunction;
import static playid.domain.fodot.FodotElementBuilder.createNot;
import static playid.domain.fodot.FodotElementBuilder.createOr;
import static playid.domain.fodot.FodotElementBuilder.createPredicate;
import static playid.domain.fodot.FodotElementBuilder.createVariable;
...
import playid.domain.fodot.vocabulary.elements.FodotArgumentListDeclaration;
