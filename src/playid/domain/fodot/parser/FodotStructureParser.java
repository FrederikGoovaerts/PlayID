package playid.domain.fodot.parser;
...
import playid.domain.exceptions.answer.StructureParsingException;
...
import playid.domain.fodot.structure.elements.predicateenum.elements.FodotPredicateBooleanEnumerationElement;
...
import playid.util.EnumerationUtil;
import playid.util.FormulaUtil;
import playid.util.ParserUtil;
